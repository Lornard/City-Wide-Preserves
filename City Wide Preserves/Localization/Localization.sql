...
WHERE	Tag = 'LOC_DISTRICT_PRESERVE_DESCRIPTION' AND Language = 'en_US';
...
WHERE	Tag = 'LOC_BUILDING_GROVE_DESCRIPTION' AND Language = 'en_US';
...
WHERE	Tag = 'LOC_BUILDING_SANCTUARY_DESCRIPTION' AND Language = 'en_US';
